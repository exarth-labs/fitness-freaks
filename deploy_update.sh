...
echo "========================================="
$EXEC_AS bash -c "cd $PROJECT_DIR && source venv/bin/activate && pip install -r requirements.txt"
...
echo "========================================="
$EXEC_AS bash -c "cd $PROJECT_DIR && source venv/bin/activate && python manage.py test"
